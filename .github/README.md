...
The repo comes with a test site for Umbraco 17. The site is configured with [Clean](https://github.com/prjseal/Clean) and [uSync](https://github.com/KevinJump/uSync) out of the box to get you up and running with a test site quickly. Use the following credentials to log into the back office:
...
## License
Copyright &copy; 2025-2026 [Rick Butterfield](https://rickbutterfield.dev), and other contributors.
