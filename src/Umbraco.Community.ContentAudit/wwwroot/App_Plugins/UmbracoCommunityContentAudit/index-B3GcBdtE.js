...
class Ln {
  ...
  async getLatestAuditOverview() {
    return await M(l(this, g), G.getLatestAuditOverview());
  }
  async getPagesWithMissingMetadata() {
    return await M(l(this, g), G.getPagesWithMissingMetadata());
  }
  async getTopIssues() {
    return await M(l(this, g), G.getAllIssues({ skip: 0, take: 5 }));
  }
  async getHealthScore() {
    return await M(l(this, g), G.getHealthScore());
  }
}
g = new WeakMap();
var oe;
class kn {
  ...
  async getSettings() {
    return await M(l(this, oe), Un.getSettings());
  }
}
oe = new WeakMap();
var I, ae;
...
f = new WeakMap(), W = new WeakMap(), V = new WeakMap(), x = new WeakMap(), j = new WeakMap(), q = new WeakMap();
const is = new nn(
  "ContentAuditContext"
...
const Wn = (t) => new Mn(typeof t == "string" ? t : t + "", void 0, os), Vn = (t, e) => {
...
class Qn {
  ...
  async getCollection(e) {
    const { data: s, error: i } = await M(l(this, le), G.getAllIssues(e));
    if (i)
      return { error: i };
    if (!s)
...
const oi = A, ai = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, ri = [li], Nt = "Umb.Workspace.ContentAudit.AllPagesRoot", D = "Umb.Workspace.ContentAudit.AllPages", ci = [
  {
    ...
    api: () => import("./all-pages-workspace.context-D9XIjHWV.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-Ewv8oxQj.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-CKkxe_am.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-Cq6yEyxH.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-PFD450xl.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-BgQ3ZBvi.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const hi = O, _i = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], bi = [...ci, ...Ci], fi = [
  {
    ...
    api: () => import("./all-pages-collection.repository-BNL3kn4S.js")
  }
], Ai = [
  {
    type: "collectionView",
...
], Ti = "Umb.Repository.ContentAudit.AllPages.Detail", gi = "Umb.Store.ContentAudit.AllPages.Detail", Ii = [
  {
    ...
    api: () => import("./all-pages-detail.repository-Cfm1_mzl.js")
  },
  {
    type: "store",
    alias: gi,
...
}, wi = [vi], Mt = "Umb.Workspace.ContentAudit.IssuesRoot", Wt = "Umb.Workspace.ContentAudit.Issues", Si = [
  {
    type: "workspace",
    kind: "routable",
    alias: Wt,
    name: "Issues Workspace",
    api: () => import("./issues-workspace.context-BkGcV_o9.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-DtTy0kwa.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], Ni = "Umb.Repository.ContentAudit.Issues.Detail", Di = "Umb.Store.ContentAudit.Issues.Detail", Ri = [
  {
    ...
    api: () => import("./issues-detail.repository-D_s7hfy1.js")
  },
  {
    type: "store",
    alias: Di,
...
}, ot = (t, e, s) => e.has(t) || ys("Cannot " + s), ze = (t, e, s) => (ot(t, e, "read from private field"), e.get(t)), Me = (t, e, s) => e.has(t) ? ys("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), Ts = (t, e, s, i) => (ot(t, e, "write to private field"), e.set(t, s), s), at = (t, e, s) => (ot(t, e, "access private method"), s), J, ve, Q, gs, Is, Es;
let v = class extends L {
  constructor() {
    super(), Me(this, Q), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
    ...
    ], this._tableItems = [], Me(this, J), Me(this, ve), this.consumeContext(k, (t) => {
      Ts(this, J, t);
...
const Hi = v, zi = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Yi = [
  {
    ...
    api: () => import("./status-codes-collection.repository-CNYtkMRV.js")
  }
], Ki = [
  {
    type: "collectionView",
...
}, rt = (t, e, s) => e.has(t) || ws("Cannot " + s), Ge = (t, e, s) => (rt(t, e, "read from private field"), e.get(t)), We = (t, e, s) => e.has(t) ? ws("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), Ss = (t, e, s, i) => (rt(t, e, "write to private field"), e.set(t, s), s), ct = (t, e, s) => (rt(t, e, "access private method"), s), Z, Se, ee, $s, Ps, Us;
let w = class extends L {
  constructor() {
    super(), We(this, ee), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
    ...
    ], this._tableItems = [], We(this, Z), We(this, Se), this.consumeContext(k, (t) => {
      Ss(this, Z, t);
...
const so = w, no = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], oo = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-BmyRXk6f.js")
  }
], ao = [
  {
    type: "collectionView",
...
}, dt = (t, e, s) => e.has(t) || Ns("Cannot " + s), Ye = (t, e, s) => (dt(t, e, "read from private field"), e.get(t)), Ve = (t, e, s) => e.has(t) ? Ns("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), Ds = (t, e, s, i) => (dt(t, e, "write to private field"), e.set(t, s), s), pt = (t, e, s) => (dt(t, e, "access private method"), s), te, Pe, se, Rs, Ms, Ws;
...
Rs = function() {
  new Xe(this, Ke).addAdditionalPath(":entityType").onSetup((t) => ({ data: { entityType: t.entityType, preset: {} } })).observeRouteBuilder((t) => {
    Ds(this, Pe, t), pt(this, se, Ms).call(this);
  });
};
Ms = function() {
  Ye(this, te) && this.observe(Ye(this, te).items, (t) => pt(this, se, Ws).call(this, t), "umbCollectionItemsObserver");
};
Ws = function(t) {
  const e = Ye(this, Pe);
  if (!e) throw new Error("Route builder not ready");
...
const _o = S, Co = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], fo = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-C3NLyzjw.js")
  }
], Ao = [
  {
    type: "collectionView",
...
const So = $, $o = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Uo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-U_QQRIVh.js")
  }
], Lo = [
  {
    type: "collectionView",
...
}, Ro = [Do], _t = "Umb.Collection.ContentAudit.InboundLinks", Mo = "Umb.CollectionView.ContentAudit.InboundLinks.Table", Gs = "Umb.Repository.ContentAuditInboundLinksCollection";
var Wo = Object.defineProperty, Vo = Object.getOwnPropertyDescriptor, Ys = (t) => {
  throw TypeError(t);
}, Le = (t, e, s, i) => {
  for (var n = i > 1 ? void 0 : i ? Vo(e, s) : e, o = t.length - 1, a; o >= 0; o--)
    (a = t[o]) && (n = (i ? a(e, s, n) : a(n)) || n);
  return i && n && Wo(e, s, n), n;
...
const jo = P, qo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ho = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-Rk5HVe5H.js")
  }
], zo = [
  {
    type: "collectionView",
...
], Qs = "Umb.Repository.ContentAuditMetadataCollection", Qo = [
  {
    ...
    api: () => import("./metadata-collection.repository-C9aA4VSv.js")
  }
], Zo = [
  {
    type: "collectionView",
...
const aa = U, la = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ua = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-BgPBD8Oo.js")
  }
], da = [
  {
    type: "collectionView",
...
}, ya = [
  {
    ...
    element: () => import("./overview.element-D0jNLfYf.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-pZKc-C10.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], ga = [
  {
    ...
    element: () => import("./run-warning-modal.element-OdOxf69c.js")
  }
], Ia = [
  {
    type: "localization",
...
//# sourceMappingURL=index-B3GcBdtE.js.map
