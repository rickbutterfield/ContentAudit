...
const Xi = v, Ji = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Zi = [Qi], an = "Umb.Workspace.ContentAudit.AllPagesRoot", M = "Umb.Workspace.ContentAudit.AllPages", ea = [
  {
    ...
    api: () => import("./all-pages-workspace.context-BjfuJVn6.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-D0Kw77Z1.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-C7Z_KCVo.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-eWDeh7Sj.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-CN-YUJOE.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-By3Zx_4D.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const aa = g, oa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ra = [...ea, ...la], ca = [
  {
    ...
    api: () => import("./all-pages-collection.repository-D85W36O1.js")
  }
], ua = [
  {
    type: "collectionView",
...
], ma = "Umb.Repository.ContentAudit.AllPages.Detail", pa = "Umb.Store.ContentAudit.AllPages.Detail", ha = [
  {
    ...
    api: () => import("./all-pages-detail.repository-oZCsUkQI.js")
  },
  {
    type: "store",
    alias: pa,
...
}, fa = [ba], rn = "Umb.Workspace.ContentAudit.IssuesRoot", cn = "Umb.Workspace.ContentAudit.Issues", Ta = [
  {
    ...
    api: () => import("./issues-workspace.context-Cl3PUZpG.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-DLopDPBF.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], wa = "Umb.Repository.ContentAudit.Issues.Detail", Oa = "Umb.Store.ContentAudit.Issues.Detail", ga = [
  {
    ...
    api: () => import("./issues-detail.repository-shC7gdb7.js")
  },
  {
    type: "store",
    alias: Oa,
...
const Ra = S, Da = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Wa = [
  {
    ...
    api: () => import("./status-codes-collection.repository--aJRw8J5.js")
  }
], Ma = [
  {
    type: "collectionView",
...
const Ha = $, Fa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Xa = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-CYoU-O0Z.js")
  }
], Ja = [
  {
    type: "collectionView",
...
const ao = P, oo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ro = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-CgaKvAmb.js")
  }
], co = [
  {
    type: "collectionView",
...
const To = U, yo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], vo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-BjWOh7kS.js")
  }
], Io = [
  {
    type: "collectionView",
...
const Lo = L, No = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ro = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-izGLA8K_.js")
  }
], Do = [
  {
    type: "collectionView",
...
], gs = "Umb.Repository.ContentAuditMetadataCollection", qo = [
  {
    ...
    api: () => import("./metadata-collection.repository-BI-CsC99.js")
  }
], Go = [
  {
    type: "collectionView",
...
const Jo = N, Qo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], tl = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-CjonJqFz.js")
  }
], nl = [
  {
    type: "collectionView",
...
const ul = k, dl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], pl = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-BB0eW65L.js")
  }
], hl = [
  {
    type: "collectionView",
...
const vl = R, Il = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], wl = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-Btaz7beI.js")
  }
], Ol = [
  {
    type: "collectionView",
...
}, Pl = [$l], Ul = "Umb.Workspace.ContentAudit.Export", Ll = [
  {
    ...
    element: () => import("./export.element-BgtoSdUf.js"),
    meta: {
      entityType: qs,
      headline: "Export"
    }
...
}, xl = [
  {
    ...
    element: () => import("./overview.element-BQt0UNTl.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-BcGOnV_x.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], Bl = [
  {
    ...
    element: () => import("./run-warning-modal.element-CPmQhqTl.js")
  }
], ql = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-BYM1dwI-.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-CkGezqvH.js.map
