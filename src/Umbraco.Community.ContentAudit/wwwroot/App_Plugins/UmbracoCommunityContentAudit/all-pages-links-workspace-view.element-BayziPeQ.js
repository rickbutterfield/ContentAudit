...
import { t as k } from "./index-Bkks3_By.js";
...
var A = Object.defineProperty, E = Object.getOwnPropertyDescriptor, b = (t) => {
  ...
  for (var s = r > 1 ? void 0 : r ? E(e, a) : e, p = t.length - 1, h; p >= 0; p--)
    (h = t[p]) && (s = (r ? h(e, a, s) : h(s)) || s);
...
let i = class extends g {
  ...
  updated(t) {
    t.has("data") && this._data && this._data?.links.length !== 0 && c(this, o, m).call(this, this._data.links);
  }
  render() {
...
//# sourceMappingURL=all-pages-links-workspace-view.element-BayziPeQ.js.map
