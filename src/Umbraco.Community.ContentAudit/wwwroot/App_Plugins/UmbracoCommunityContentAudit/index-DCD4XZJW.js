...
const is = I, ss = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Symbol.toStringTag, { value: "Module" })), nt = "ContentAudit.Collection.Audits", os = "ContentAudit.CollectionView.Audits.Table", Ra = "ContentAudit.Repository.AuditsCollection", rs = [
  {
    ...
    api: () => import("./audits-collection.repository-GxeF2FDp.js")
  }
], ls = [
  {
    type: "collectionView",
...
], Wa = "audits", xa = "audits-root", us = [
  {
    ...
    weight: 100,
    api: () => import("./delete-audit.action-BL8_7Jwx.js"),
    forEntityTypes: [Wa],
    meta: {
      icon: "icon-trash",
      label: "Delete"
...
], ms = [
  {
    ...
    api: () => import("./audits-tree.repository-7HhQHmlx.js")
  },
  {
    type: "tree",
    kind: "default",
...
], ps = [
  {
    ...
    api: () => import("./audits-workspace.context-alDy1ZEE.js"),
    meta: {
      entityType: "audits"
    }
  },
  {
    ...
    js: () => import("./audits-overview-workspace-view.element-CdsLMuBz.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  },
  {
    ...
    js: () => import("./audits-issues-workspace-view.element-D-6k4jFT.js"),
    weight: 80,
    meta: {
      label: "Issues",
      pathname: "issues",
...
}, As = [fs], xt = "ContentAudit.Workspace.AllPagesRoot", F = "ContentAudit.Workspace.AllPages", bs = [
  {
    ...
    api: () => import("./all-pages-workspace.context-mxKV2W4w.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-BS04bq_V.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-CaOaWOsF.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-CMDp6lOQ.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-DgJ0Hcbb.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-BjZLpKr8.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const ws = P, Is = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Es = [...bs, ...Os], Ss = [
  {
    ...
    api: () => import("./all-pages-collection.repository-B6u7xuub.js")
  }
], $s = [
  {
    type: "collectionView",
...
], ks = "ContentAudit.Repository.AllPages.Detail", Ls = "ContentAudit.Store.AllPages.Detail", Ns = [
  {
    ...
    api: () => import("./all-pages-detail.repository-1uYsKLBz.js")
  },
  {
    type: "store",
    alias: Ls,
...
}, Rs = [Us], Bt = "ContentAudit.Workspace.IssuesRoot", zt = "ContentAudit.Workspace.Issues", Ws = [
  {
    ...
    api: () => import("./issues-workspace.context-CIeZOLhk.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-BqJ-Cg1q.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], qs = "ContentAudit.Repository.Issues.Detail", Ys = "ContentAudit.Store.Issues.Detail", Fs = [
  {
    ...
    api: () => import("./issues-detail.repository-DsK5pjqb.js")
  },
  {
    type: "store",
    alias: Ys,
...
const to = k, ao = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], io = [
  {
    ...
    api: () => import("./status-codes-collection.repository-BeJxMVov.js")
  }
], so = [
  {
    type: "collectionView",
...
const Co = L, _o = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ao = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-CkARjPbl.js")
  }
], bo = [
  {
    type: "collectionView",
...
const So = N, $o = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ko = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-vd76C2HO.js")
  }
], Lo = [
  {
    type: "collectionView",
...
const jo = D, Bo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], qo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-CYUSkA7v.js")
  }
], Yo = [
  {
    type: "collectionView",
...
const er = V, tr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], nr = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-3LjLQENy.js")
  }
], ir = [
  {
    type: "collectionView",
...
], In = "ContentAudit.Repository.MetadataCollection", dr = [
  {
    ...
    api: () => import("./metadata-collection.repository-DBnzWRVH.js")
  }
], mr = [
  {
    type: "collectionView",
...
const br = U, yr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], vr = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-DGJtxAOk.js")
  }
], wr = [
  {
    type: "collectionView",
...
const Nr = R, Dr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ur = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-DmhQ7ZaX.js")
  }
], Rr = [
  {
    type: "collectionView",
...
const Fr = W, Hr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Gr = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-ma4OnMS2.js")
  }
], Xr = [
  {
    type: "collectionView",
...
}, el = [Zr], tl = "ContentAudit.Workspace.Export", al = [
  {
    ...
    element: () => import("./export.element-awGRKQhQ.js"),
    meta: {
      entityType: xn,
      headline: "Export"
    }
...
}, ul = [
  {
    ...
    element: () => import("./overview.element-6d2g0Z2I.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-VEfhcuFA.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], ml = [
  {
    ...
    element: () => import("./run-warning-modal.element-Dwu_MrLA.js")
  }
], pl = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-MAIgxiKt.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-DCD4XZJW.js.map
