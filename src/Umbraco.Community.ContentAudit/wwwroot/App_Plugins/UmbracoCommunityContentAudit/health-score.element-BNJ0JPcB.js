...
}, w = (r, e, t) => e.has(r) || u("Cannot " + t), y = (r, e, t) => e.has(r) ? u("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(r) : e.set(r, t), k = (r, e, t) => (w(r, e, "access private method"), t), c, _;
  ...
  render() {
    return this.score === void 0 || this.score === null ? f : v`
            <uui-box .headline=${this.headline}>
                <div class="score">
                    <svg viewBox="0 0 36 36" class="score__inner ${k(this, c, _).call(this)}">
...
//# sourceMappingURL=health-score.element-BNJ0JPcB.js.map
