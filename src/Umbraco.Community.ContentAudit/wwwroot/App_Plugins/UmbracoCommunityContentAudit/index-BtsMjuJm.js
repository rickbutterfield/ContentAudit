...
import { LitElement as K, html as c, css as I, property as F, customElement as b, nothing as Ce, state as d } from "@umbraco-cms/backoffice/external/lit";
...
import { UMB_COLLECTION_CONTEXT as X, UMB_COLLECTION_ALIAS_CONDITION as L } from "@umbraco-cms/backoffice/collection";
...
const u = {
  ...
  try {
    const o = Ss(e, t), a = Os(t), l = Is(t), y = await Es(e, t);
    if (!i.isCancelled) {
...
class Rs extends fe {
  constructor(s) {
    ...
    p(this, A);
    p(this, z);
    m(this, A, new ks(this)), m(this, z, new Ls(this));
  }
  async getLatestAuditOverview() {
...
class vt extends fe {
  constructor(s) {
    ...
    p(this, N);
    p(this, k);
    this.workspaceAlias = ot, m(this, $, new yt(void 0)), this.latestAuditOverview = r(this, $).asObservable(), m(this, U, new zt([], (n) => n.id)), this.pagesWithMissingMetadata = r(this, U).asObservable(), m(this, P, new zt([], (n) => n.name)), this.topIssues = r(this, P).asObservable(), m(this, N, new yt(void 0)), this.healthScore = r(this, N).asObservable(), m(this, k, new yt(void 0)), this.settings = r(this, k).asObservable(), this.provideContext(rs, this), this.provideContext(ve, this), m(this, C, new Rs(this));
  }
  getEntityType() {
    return Ae;
  }
  ...
  async getSettings() {
    ...
    s && r(this, k).setValue(s);
  }
}
C = new WeakMap(), $ = new WeakMap(), U = new WeakMap(), P = new WeakMap(), N = new WeakMap(), k = new WeakMap();
const ve = new as(
  "ContentAuditContext"
), Ds = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CONTENT_AUDIT_CONTEXT_TOKEN: ve,
  ContentAuditContext: vt,
  default: vt
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const st = globalThis, It = st.ShadowRoot && (st.ShadyCSS === void 0 || st.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Se = Symbol(), Kt = /* @__PURE__ */ new WeakMap();
let xs = class {
  constructor(t, s, n) {
  ...
  get styleSheet() {
    ...
    if (It && t === void 0) {
      ...
      n && (t = Kt.get(s)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), n && Kt.set(s, t));
    }
    return t;
  }
  toString() {
...
const Ws = (e) => new xs(typeof e == "string" ? e : e + "", void 0, Se), Vs = (e, t) => {
...
}, Ft = It ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let s = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: js, defineProperty: qs, getOwnPropertyDescriptor: Bs, getOwnPropertyNames: Hs, getOwnPropertySymbols: zs, getPrototypeOf: Gs } = Object, g = globalThis, Xt = g.trustedTypes, Ys = Xt ? Xt.emptyScript : "", At = g.reactiveElementPolyfillSupport, M = (e, t) => e, St = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ys : null;
      break;
  ...
  return s;
} }, Oe = (e, t) => !js(e, t), Jt = { attribute: !0, type: String, converter: St, reflect: !1, hasChanged: Oe };
...
class R extends HTMLElement {
  ...
  _$EC(t, s) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const a = (((o = n.converter) == null ? void 0 : o.toAttribute) !== void 0 ? n.converter : St).toAttribute(s, n.type);
  ...
  _$AK(t, s) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const a = n.getPropertyOptions(i), l = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((o = a.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? a.converter : St;
...
var Ks = Object.defineProperty, Fs = Object.getOwnPropertyDescriptor, Xs = (e, t, s, n) => {
  for (var i = n > 1 ? void 0 : n ? Fs(t, s) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = (n ? a(t, s, i) : a(i)) || i);
  return n && i && Ks(t, s, i), i;
};
let at = class extends mt(K) {
  constructor() {
    super(), this._workspaceContext = new vt(this);
  }
  render() {
    return c`
...
}, Sn = [vn], Pt = "Umb.Collection.ContentAudit.StatusCodes", On = "Umb.CollectionView.ContentAudit.StatusCodes.Table", Ne = "Umb.Repository.ContentAuditStatusCodesCollection";
var En = Object.defineProperty, In = Object.getOwnPropertyDescriptor, ke = (e) => {
  throw TypeError(e);
}, _t = (e, t, s, n) => {
  for (var i = n > 1 ? void 0 : n ? In(t, s) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = (n ? a(t, s, i) : a(i)) || i);
  return n && i && En(t, s, i), i;
}, Nt = (e, t, s) => t.has(e) || ke("Cannot " + s), ne = (e, t, s) => (Nt(e, t, "read from private field"), t.get(e)), ie = (e, t, s) => t.has(e) ? ke("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), wn = (e, t, s, n) => (Nt(e, t, "write to private field"), t.set(e, s), s), Le = (e, t, s) => (Nt(e, t, "access private method"), s), V, lt, Re, De;
let v = class extends J {
  constructor() {
    super(), ie(this, lt), this._tableConfig = {
      ...
      wn(this, V, e), Le(this, lt, Re).call(this);
    });
  }
  render() {
    if (this._tableItems.length !== 0)
...
const $n = v, Un = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
}, Mn = [Dn], kt = "Umb.Collection.ContentAudit.OrphanedPages", xn = "Umb.CollectionView.ContentAudit.OrphanedPages.Table", xe = "Umb.Repository.ContentAuditOrphanedPagesCollection";
...
}, Lt = (e, t, s) => t.has(e) || We("Cannot " + s), ae = (e, t, s) => (Lt(e, t, "read from private field"), t.get(e)), re = (e, t, s) => t.has(e) ? We("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), jn = (e, t, s, n) => (Lt(e, t, "write to private field"), t.set(e, s), s), Ve = (e, t, s) => (Lt(e, t, "access private method"), s), j, ct, je, qe;
...
const qn = S, Bn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
}, Xn = [Fn], Rt = "Umb.Collection.ContentAudit.ImagesAltText", Jn = "Umb.CollectionView.ContentAudit.ImagesAltText.Table", He = "Umb.Repository.ContentAuditImagesAltTextCollection";
...
}, Dt = (e, t, s) => t.has(e) || ze("Cannot " + s), ce = (e, t, s) => (Dt(e, t, "read from private field"), t.get(e)), ue = (e, t, s) => t.has(e) ? ze("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), ti = (e, t, s, n) => (Dt(e, t, "write to private field"), t.set(e, s), s), Ge = (e, t, s) => (Dt(e, t, "access private method"), s), q, ut, Ye, Ke;
...
Ye = function() {
  ce(this, q) && this.observe(ce(this, q).items, (e) => Ge(this, ut, Ke).call(this, e), "umbCollectionItemsObserver");
};
Ke = function(e) {
  this._tableItems = e.map((t) => ({
    id: t.unique,
    ...
    data: [
      ...
      },
      {
        ...
        value: c`<a href="/umbraco/section/content/workspace/document/edit/${t.nodeKey}">${t.foundPage}</a>`
      },
      {
        columnAlias: "altText",
        value: t.altText
...
const hi = E, _i = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, gi = [Ai], Wt = "Umb.Collection.ContentAudit.Metadata", vi = "Umb.CollectionView.ContentAudit.Metadata.Table", _e = "Umb.Workspace.ContentAudit.Metadata", Si = [
  {
    type: "workspace",
    kind: "default",
    alias: _e,
...
], Ei = [
  {
    ...
    js: () => import("./metadata-table-collection-view.element-A3MmY2l4.js"),
    meta: {
      label: "Table",
      icon: "icon-list",
      pathName: "table"
