...
import { ContentAuditIssuesDetailRepository as P } from "./issues-detail.repository-aa7NkF4o.js";
import { UmbObjectState as I } from "@umbraco-cms/backoffice/observable-api";
import { a as N } from "./index-CKBR_9pg.js";
var W = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (t) => {
  throw TypeError(t);
}, v = (t, e, s, r) => {
  for (var o = r > 1 ? void 0 : r ? b(e, s) : e, n = t.length - 1, h; n >= 0; n--)
    (h = t[n]) && (o = (r ? h(e, s, o) : h(o)) || o);
  return r && o && W(e, s, o), o;
...
class F extends f {
  constructor(s) {
    super(s, T);
    c(this, a);
    this.workspaceAlias = N, this.repository = new P(this), m(this, a, new I(void 0)), this.data = i(this, a).asObservable(), this.unique = i(this, a).asObservablePart((r) => r == null ? void 0 : r.unique), this.routes = new y(this), this.routes.setRoutes([
      {
        path: "edit/:unique",
        component: u,
        setup: (r, o) => {
...
//# sourceMappingURL=issues-workspace.context-BZ5BgVPT.js.map
