...
var $ = Object.defineProperty, w = Object.getOwnPropertyDescriptor, v = (t) => {
  ...
  for (var r = s > 1 ? void 0 : s ? w(e, a) : e, p = t.length - 1, _; p >= 0; p--)
    (_ = t[p]) && (r = (s ? _(e, a, r) : _(r)) || r);
  return s && r && $(e, a, r), r;
}, b = (t, e, a) => e.has(t) || v("Cannot " + a), c = (t, e, a) => (b(t, e, "read from private field"), e.get(t)), m = (t, e, a) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), d = (t, e, a, s) => (b(t, e, "write to private field"), e.set(t, a), a), n, o;
  ...
  constructor() {
    super(), this._documentUnique = "", this._routes = [], this._activePath = "", m(this, n), m(this, o), this.consumeContext(P, (t) => {
      ...
      d(this, n, t), this.observe(
        ...
        (a) => {
          var s;
          this._documentUnique = a, d(this, o, new y(this)), (s = c(this, o)) == null || s.load(this._documentUnique);
        },
        "_documentUnique"
      );
