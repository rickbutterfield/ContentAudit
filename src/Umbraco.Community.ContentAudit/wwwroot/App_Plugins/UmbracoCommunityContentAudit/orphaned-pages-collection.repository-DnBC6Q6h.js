...
import { A as h } from "./index-CnvXRotu.js";
...
class f {
  ...
  async getCollection(o) {
    const { data: t, error: r } = await C(n(this, s), h.getOrphanedPages({ query: o }));
    if (r)
      return { error: r };
    if (!t)
...
//# sourceMappingURL=orphaned-pages-collection.repository-DnBC6Q6h.js.map
