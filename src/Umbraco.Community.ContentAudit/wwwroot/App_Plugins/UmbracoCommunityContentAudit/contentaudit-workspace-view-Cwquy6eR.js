...
import { ContentAuditAllPagesWorkspaceContext as g, CONTENT_AUDIT_ALL_PAGES_WORKSPACE_CONTEXT as y } from "./all-pages-workspace.context-EmyKh6TL.js";
...
let s = class extends C {
  ...
  _createRoutes() {
    ...
    t.push({
      path: "details",
      component: () => import("./all-pages-details-workspace-view.element-B8JAsstX.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "links",
      component: () => import("./all-pages-links-workspace-view.element-D7Y8vHKi.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "images",
      component: () => import("./all-pages-images-workspace-view.element-q4l8HDNs.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "resources",
      component: () => import("./all-pages-resources-workspace-view.element--q3iaVS9.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "issues",
      component: () => import("./all-pages-issues-workspace-view.element-SoKjWFjr.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.length !== 0 && t.push({
...
//# sourceMappingURL=contentaudit-workspace-view-Cwquy6eR.js.map
