...
import { ContentAuditAllPagesWorkspaceContext as E, CONTENT_AUDIT_ALL_PAGES_WORKSPACE_CONTEXT as $ } from "./all-pages-workspace.context-BjfuJVn6.js";
...
let s = class extends f(C) {
  ...
  _createRoutes() {
    ...
    t.push({
      path: "details",
      component: () => import("./all-pages-details-workspace-view.element-D0Kw77Z1.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "links",
      component: () => import("./all-pages-links-workspace-view.element-C7Z_KCVo.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "images",
      component: () => import("./all-pages-images-workspace-view.element-eWDeh7Sj.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "resources",
      component: () => import("./all-pages-resources-workspace-view.element-CN-YUJOE.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "issues",
      component: () => import("./all-pages-issues-workspace-view.element-By3Zx_4D.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.length !== 0 && t.push({
...
//# sourceMappingURL=contentaudit-workspace-view-BYM1dwI-.js.map
