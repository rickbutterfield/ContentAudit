...
const is = I, ss = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Symbol.toStringTag, { value: "Module" })), nt = "ContentAudit.Collection.Audits", os = "ContentAudit.CollectionView.Audits.Table", Ra = "ContentAudit.Repository.AuditsCollection", rs = [
  {
    ...
    api: () => import("./audits-collection.repository-D2mYIOvh.js")
  }
], ls = [
  {
    type: "collectionView",
...
], Wa = "audits", xa = "audits-root", us = [
  {
    ...
    weight: 100,
    api: () => import("./delete-audit.action-DdTNC4fp.js"),
    forEntityTypes: [Wa],
    meta: {
      icon: "icon-trash",
      label: "Delete"
...
], ms = [
  {
    ...
    api: () => import("./audits-tree.repository-75fJwbLT.js")
  },
  {
    type: "tree",
    kind: "default",
...
], ps = [
  {
    ...
    api: () => import("./audits-workspace.context-TUVonl2N.js"),
    meta: {
      entityType: "audits"
    }
  },
  {
    ...
    js: () => import("./audits-overview-workspace-view.element-DiLbhv5h.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  },
  {
    ...
    js: () => import("./audits-issues-workspace-view.element-BMgcIuXh.js"),
    weight: 80,
    meta: {
      label: "Issues",
      pathname: "issues",
...
}, As = [fs], xt = "ContentAudit.Workspace.AllPagesRoot", F = "ContentAudit.Workspace.AllPages", bs = [
  {
    ...
    api: () => import("./all-pages-workspace.context-C_4Z3Gw9.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-fKjj9Ik3.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-Dts1FEE9.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-C13OhvzO.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-Br-gmwd6.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-CA5jQKXN.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const ws = P, Is = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Es = [...bs, ...Os], Ss = [
  {
    ...
    api: () => import("./all-pages-collection.repository-D1olEE1E.js")
  }
], $s = [
  {
    type: "collectionView",
...
], ks = "ContentAudit.Repository.AllPages.Detail", Ls = "ContentAudit.Store.AllPages.Detail", Ns = [
  {
    ...
    api: () => import("./all-pages-detail.repository-C68jaj1z.js")
  },
  {
    type: "store",
    alias: Ls,
...
}, Rs = [Us], Bt = "ContentAudit.Workspace.IssuesRoot", zt = "ContentAudit.Workspace.Issues", Ws = [
  {
    ...
    api: () => import("./issues-workspace.context-AXfjl2uY.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-CjaNncXh.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], qs = "ContentAudit.Repository.Issues.Detail", Ys = "ContentAudit.Store.Issues.Detail", Fs = [
  {
    ...
    api: () => import("./issues-detail.repository-Bomac4So.js")
  },
  {
    type: "store",
    alias: Ys,
...
const to = k, ao = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], io = [
  {
    ...
    api: () => import("./status-codes-collection.repository-DMN-5lUx.js")
  }
], so = [
  {
    type: "collectionView",
...
const Co = L, _o = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ao = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-DQkQ9uLP.js")
  }
], bo = [
  {
    type: "collectionView",
...
const So = N, $o = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ko = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-CuEj3qPF.js")
  }
], Lo = [
  {
    type: "collectionView",
...
const jo = D, Bo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], qo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-CJV0UxYH.js")
  }
], Yo = [
  {
    type: "collectionView",
...
const er = V, tr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], nr = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-CiFuRLyO.js")
  }
], ir = [
  {
    type: "collectionView",
...
], In = "ContentAudit.Repository.MetadataCollection", dr = [
  {
    ...
    api: () => import("./metadata-collection.repository-VXzrjyTh.js")
  }
], mr = [
  {
    type: "collectionView",
...
const br = U, yr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], vr = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-Ce367Yau.js")
  }
], wr = [
  {
    type: "collectionView",
...
const Nr = R, Dr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ur = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-CWe_1Td1.js")
  }
], Rr = [
  {
    type: "collectionView",
...
const Fr = W, Hr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Gr = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-CuW6sQLH.js")
  }
], Xr = [
  {
    type: "collectionView",
...
}, el = [Zr], tl = "ContentAudit.Workspace.Export", al = [
  {
    ...
    element: () => import("./export.element-DqbG6-9B.js"),
    meta: {
      entityType: xn,
      headline: "Export"
    }
...
}, ul = [
  {
    ...
    element: () => import("./overview.element-Cxvn6kAC.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-_QuZbEWK.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], ml = [
  {
    ...
    element: () => import("./run-warning-modal.element-CxiLbPn3.js")
  }
], pl = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-BOz79-0D.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-stcFC0Hx.js.map
