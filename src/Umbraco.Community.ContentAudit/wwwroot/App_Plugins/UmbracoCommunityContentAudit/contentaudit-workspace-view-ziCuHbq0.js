...
import { html as l, state as h, customElement as f } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as C } from "@umbraco-cms/backoffice/lit-element";
import { ContentAuditAllPagesWorkspaceContext as g, CONTENT_AUDIT_ALL_PAGES_WORKSPACE_CONTEXT as y } from "./all-pages-workspace.context-C6yedWIy.js";
var E = Object.defineProperty, $ = Object.getOwnPropertyDescriptor, v = (t) => {
  throw TypeError(t);
}, o = (t, e, a, u) => {
  for (var i = u > 1 ? void 0 : u ? $(e, a) : e, p = t.length - 1, _; p >= 0; p--)
    (_ = t[p]) && (i = (u ? _(e, a, i) : _(i)) || i);
  return u && i && E(e, a, i), i;
...
let s = class extends C {
  constructor() {
    super(), this._documentUnique = "", this._routes = [], this._activePath = "", m(this, n), m(this, r), this.consumeContext(P, (t) => {
      d(this, n, t), this.observe(
        c(this, n)?.unique,
        (e) => {
          this._documentUnique = e, d(this, r, new g(this)), c(this, r)?.load(this._documentUnique);
        },
        "_documentUnique"
      );
  ...
  _createRoutes() {
    ...
    t.push({
      path: "details",
      component: () => import("./all-pages-details-workspace-view.element-CvOBUx1v.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "links",
      component: () => import("./all-pages-links-workspace-view.element-6zyaD8II.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "images",
      component: () => import("./all-pages-images-workspace-view.element-D3VwEfMq.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "resources",
      component: () => import("./all-pages-resources-workspace-view.element-D7d4FqOO.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "issues",
      component: () => import("./all-pages-issues-workspace-view.element-DQ1VhXOK.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.length !== 0 && t.push({
...
//# sourceMappingURL=contentaudit-workspace-view-ziCuHbq0.js.map
