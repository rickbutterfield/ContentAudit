...
import { A as a } from "./index-Bkks3_By.js";
...
class l extends s {
  ...
  async requestByUnique(t) {
    ...
    return r && this.#r.append(r), { data: r, error: i, asObservable: () => this.#r.byUnique(t) };
  }
  async byUnique(t) {
    if (!t) throw new Error("Unique is missing");
...
//# sourceMappingURL=all-pages-detail.repository-iY0_8dQt.js.map
