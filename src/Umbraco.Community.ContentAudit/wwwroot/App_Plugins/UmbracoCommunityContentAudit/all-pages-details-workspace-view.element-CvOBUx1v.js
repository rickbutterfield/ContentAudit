...
import { t as f } from "./index-DCtP17IU.js";
import { r as c } from "./state-BBZxen1F.js";
import { CONTENT_AUDIT_ALL_PAGES_WORKSPACE_CONTEXT as C } from "./all-pages-workspace.context-C6yedWIy.js";
...
var T = Object.defineProperty, w = Object.getOwnPropertyDescriptor, v = (t) => {
  throw TypeError(t);
}, y = (t, a, o, r) => {
  for (var i = r > 1 ? void 0 : r ? w(a, o) : a, d = t.length - 1, p; d >= 0; d--)
    (p = t[d]) && (i = (r ? p(a, o, i) : p(i)) || i);
  return r && i && T(a, o, i), i;
}, b = (t, a, o) => a.has(t) || v("Cannot " + o), h = (t, a, o) => (b(t, a, "read from private field"), a.get(t)), m = (t, a, o) => a.has(t) ? v("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(t) : a.set(t, o), A = (t, a, o, r) => (b(t, a, "write to private field"), a.set(t, o), o), n = (t, a, o) => (b(t, a, "access private method"), o), s, u, _, $, D;
let l = class extends g {
  constructor() {
    super(), m(this, u), this._documentUnique = "", m(this, s), this.consumeContext(C, (t) => {
      A(this, s, t), n(this, u, _).call(this);
    });
  }
  render() {
    return this._data ? e`
			${n(this, u, $).call(this)}
			${n(this, u, D).call(this)}
...
_ = function() {
  h(this, s) && this.observe(h(this, s).data, (t) => {
    this._data = t;
...
y([
  c()
], l.prototype, "_documentUnique", 2);
l = y([
  f("content-audit-all-pages-details-workspace-view")
], l);
const I = l;
export {
  l as ContentAuditAllPagesDetailsWorkspaceViewElement,
  I as default
};
//# sourceMappingURL=all-pages-details-workspace-view.element-CvOBUx1v.js.map
