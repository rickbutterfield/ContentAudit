import { html as n, nothing as x, css as G, state as f, customElement as W } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as B } from "@umbraco-cms/backoffice/lit-element";
import { C as H } from "./index-IUh43tSs.js";
import { UmbModalToken as F, UMB_MODAL_MANAGER_CONTEXT as V } from "@umbraco-cms/backoffice/modal";
import "./run-warning-modal.element-B4JVQR88.js";
...
const K = new F("ContentAudit.Modal.RunWarning", {
  modal: {
    type: "dialog",
    size: "small"
  }
});
var Y = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, k = (e) => {
  throw TypeError(e);
}, w = (e, t, a, r) => {
  for (var u = r > 1 ? void 0 : r ? Z(t, a) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (u = (r ? s(t, a, u) : s(u)) || u);
  return r && u && Y(t, a, u), u;
}, C = (e, t, a) => t.has(e) || k("Cannot " + a), c = (e, t, a) => (C(e, t, "read from private field"), t.get(e)), g = (e, t, a) => t.has(e) ? k("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), y = (e, t, a, r) => (C(e, t, "write to private field"), t.set(e, a), a), o = (e, t, a) => (C(e, t, "access private method"), a), v, _, p, m, l, O, z, T, S, E, D, R, U, I, N, L, M;
let h = class extends B {
  constructor() {
    super(), g(this, l), this._crawlData = [], this._crawlPhase = "", g(this, v), g(this, _), g(this, p), this.scanRunning = !1, this._auditOverviews = [], this._topIssues = [], g(this, m, !1), this.consumeContext(X, (e) => {
      y(this, p, e);
      ...
      y(this, v, e), this.observe(e?.latestAuditOverview, (t) => {
        ...
        const a = c(this, m);
        this.scanRunning = t, y(this, m, t ?? !1), a && !t && this.isConnected && o(this, l, z).call(this);
  ...
  async _openModal() {
    (await c(this, _)?.open(this, K, {
      data: {
        headline: "Ready to run an audit?"
      }
    })?.onSubmit())?.run && o(this, l, T).call(this);
  }
  render() {
    return this.scanRunning ? o(this, l, U).call(this) : !this._latestAuditOverview || this._latestAuditOverview.runDate == null ? o(this, l, D).call(this) : n`
            <div id="main">
                ${o(this, l, I).call(this)}
                ${o(this, l, N).call(this)}
                ${o(this, l, L).call(this)}
                ${o(this, l, M).call(this)}
            </div>
        `;
  }
};
...
O = function() {
  c(this, v)?.getLatestAuditOverview(), c(this, v)?.getAuditOverviews(), c(this, v)?.getTopIssues(), c(this, v)?.getHealthScore();
};
z = async function() {
  c(this, p)?.peek("default", {
...
T = async function() {
  try {
    await c(this, v).startCrawl(), c(this, p)?.peek("positive", {
      data: {
...
S = async function() {
  try {
    await c(this, v).cancelCrawl(), c(this, p)?.peek("warning", {
...
R = function() {
  ...
  return e.length === 0 ? x : n`
            <div class="activity-feed">
                ${e.map((t) => {
    const a = o(this, l, E).call(this, t), r = t.url ? t.url.length > 70 ? t.url.substring(0, 70) + "…" : t.url : "Unknown URL";
    return n`
                        <div class="activity-feed-item">
                            <uui-tag color=${a.color} look="secondary">${a.label}</uui-tag>
                            <span class="activity-feed-url">${r}</span>
                        </div>
                    `;
  })}
            </div>
...
U = function() {
  const e = this._crawlData.length, t = this._crawlData.filter((i) => i.crawled && !i.external && !i.asset).length, a = this._crawlData.filter((i) => i.crawled && i.external && !i.asset).length, r = this._crawlData.filter((i) => i.crawled && i.asset).length, u = this._crawlData.filter((i) => i.blocked).length;
  return n`
            <div class="overlay">
                <div class="overlay-content">
                    ${this._crawlPhase ? n`<div class="crawl-phase"><uui-loader-circle></uui-loader-circle> ${this._crawlPhase}</div>` : x}
                    ...
                    <div class="crawl-stats">
                        ...
                        <div class="crawl-stat">
                            <div class="crawl-stat-value">${r}</div>
                    ...
                    ${o(this, l, R).call(this)}

                    <div class="overlay-actions">
                        <uui-button look="secondary" color="danger" @click=${o(this, l, S)}>Cancel</uui-button>
                    </div>
                </div>
            </div>
        `;
...
L = function() {
  ...
  const e = this._auditOverviews.slice(0, 10).reverse(), t = 150, a = 100, r = e.map((s, d) => {
    const b = d / (e.length - 1) * a, $ = t - (s.healthScore || 0) / 100 * t;
    return `${b},${$}`;
  ...
  return n`
    ...
    return n`
                        ...
                        <!-- Data points -->
                        ${e.map((s, d) => {
    const b = d / (e.length - 1) * a, $ = t - (s.healthScore || 0) / 100 * t, A = s.healthScore || 0, P = A >= 90 ? "var(--uui-color-positive)" : A >= 50 ? "var(--uui-color-warning)" : "var(--uui-color-danger)";
    return n`
                                <circle
                                    cx="${b}"
                                    cy="${$}"
...
//# sourceMappingURL=overview.element-o1-Hb6JJ.js.map
