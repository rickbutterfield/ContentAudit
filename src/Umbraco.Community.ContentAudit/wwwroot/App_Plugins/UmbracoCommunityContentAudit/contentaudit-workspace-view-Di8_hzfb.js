...
import { ContentAuditAllPagesWorkspaceContext as g, CONTENT_AUDIT_ALL_PAGES_WORKSPACE_CONTEXT as y } from "./all-pages-workspace.context-DEWmO3Vr.js";
...
let i = class extends C {
  ...
  _createRoutes() {
    ...
    t.push({
      path: "details",
      component: () => import("./all-pages-details-workspace-view.element-BEzvFfHa.js")
      //setup: (component) => {
      //    (component as ContentAuditAllPagesDetailsWorkspaceViewElement)._data = this._data;
      //}
    }), t.push({
      path: "links",
      component: () => import("./all-pages-links-workspace-view.element-DfuDOVZe.js")
      //setup: (component) => {
      //    //(component as ContentAuditAllPagesLinksWorkspaceViewElement)._data = this._data;
      //}
    }), t.push({
      path: "images",
      component: () => import("./all-pages-images-workspace-view.element-BjWTGfYj.js")
      //setup: (component) => {
      //    //(component as ContentAuditAllPagesImagesWorkspaceViewElement)._data = this._data;
      //}
    }), t.push({
      path: "resources",
      component: () => import("./all-pages-resources-workspace-view.element-CsuIQtJ9.js")
      //setup: (component) => {
      //    //(component as ContentAuditAllPagesResourcesWorkspaceViewElement)._data = this._data;
      //}
    }), t.push({
      path: "issues",
      component: () => import("./all-pages-issues-workspace-view.element-CXO8FLGx.js")
      //setup: (component) => {
...
//# sourceMappingURL=contentaudit-workspace-view-Di8_hzfb.js.map
