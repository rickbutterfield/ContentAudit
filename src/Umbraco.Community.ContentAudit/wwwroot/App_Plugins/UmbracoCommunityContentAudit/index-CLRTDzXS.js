...
var u = (t, e, n) => (Yt(t, e, "read from private field"), n ? n.call(t) : e.get(t)), _ = (t, e, n) => e.has(t) ? zt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), C = (t, e, n, s) => (Yt(t, e, "write to private field"), s ? s.call(t, n) : e.set(t, n), n);
...
import { LitElement as D, html as r, css as p, property as V, customElement as m, nothing as vn, state as c } from "@umbraco-cms/backoffice/external/lit";
...
var Zi = Object.defineProperty, es = Object.getOwnPropertyDescriptor, En = (t, e, n, s) => {
  for (var i = s > 1 ? void 0 : s ? es(e, n) : e, a = t.length - 1, o; a >= 0; a--)
    (o = t[a]) && (i = (s ? o(e, n, i) : o(i)) || i);
  return s && i && Zi(e, n, i), i;
};
let Ee = class extends H(D) {
  constructor() {
    super(...arguments), this.type = 0;
  }
  render() {
...
let it = class extends H(D) {
  ...
  render() {
    return this.statusCode !== void 0 && this.statusCode != 0 ? r`<uui-tag color=${this._getColor(this.statusCode)}>${this.statusCode}</uui-tag>` : vn;
  }
};
wn([
  V({ attribute: !1 })
...
const d = {
  ...
  for (const f of t.interceptors.request._fns)
    h = await f(h);
  return o(() => l.abort()), await fetch(n, h);
}, hs = (t, e) => {
  if (e) {
...
}, b = (t, e) => new os(async (n, s, i) => {
  try {
    const a = cs(t, e), o = us(e), l = ms(e), h = await ds(t, e);
    if (!i.isCancelled) {
      let f = await ps(t, e, a, l, o, h, i);
      for (const qi of t.interceptors.response._fns)
        f = await qi(f);
      const Bt = await _s(f), Bi = hs(f, e.responseHeader);
      let qt = Bt;
      e.responseTransformer && f.ok && (qt = await e.responseTransformer(Bt));
      const Gt = {
        url: a,
        ok: f.ok,
        status: f.status,
...
const Oe = "Umb.Workspace.ContentAudit", ys = "Umb.Context.ContentAudit", Un = "content-audit";
var g;
class As {
  constructor(e) {
    _(this, g);
  ...
  async getLatestAuditOverview() {
    return await j(u(this, g), K.getLatestAuditOverview());
  }
  async getPagesWithMissingMetadata() {
    return await j(u(this, g), K.getPagesWithMissingMetadata());
  }
  async getTopIssues() {
    return await j(u(this, g), K.getAllIssues({ skip: 0, take: 5 }));
  }
  async getHealthScore() {
    return await j(u(this, g), K.getHealthScore());
  }
}
g = new WeakMap();
var pe;
class vs {
  ...
  async getSettings() {
    return await j(u(this, pe), bs.getSettings());
  }
}
pe = new WeakMap();
var E, he;
class Is extends In {
  constructor(n) {
    ...
    _(this, E);
    _(this, he);
    C(this, E, new As(this)), C(this, he, new vs(this));
  }
  async getLatestAuditOverview() {
    return u(this, E).getLatestAuditOverview();
  }
  async getPagesWithMissingMetadata() {
    return u(this, E).getPagesWithMissingMetadata();
  }
  async getTopIssues() {
    return u(this, E).getTopIssues();
  }
  async getHealthScore() {
    return u(this, E).getHealthScore();
  }
  async getSettings() {
    return u(this, he).getSettings();
  }
}
E = new WeakMap(), he = new WeakMap();
var A, B, q, G, z, Y;
class ot extends In {
  constructor(n) {
    super(n);
    ...
    _(this, z);
    _(this, Y);
    this.workspaceAlias = Oe, C(this, B, new Ke(void 0)), this.latestAuditOverview = u(this, B).asObservable(), C(this, q, new Ht([], (s) => s.unique)), this.pagesWithMissingMetadata = u(this, q).asObservable(), C(this, G, new Ht([], (s) => s.name)), this.topIssues = u(this, G).asObservable(), C(this, z, new Ke(void 0)), this.healthScore = u(this, z).asObservable(), C(this, Y, new Ke(void 0)), this.settings = u(this, Y).asObservable(), this.provideContext(Yi, this), this.provideContext(Ln, this), C(this, A, new Is(this));
  }
  getEntityType() {
    return Un;
  }
  ...
  async getSettings() {
    ...
    n && u(this, Y).setValue(n);
  }
}
A = new WeakMap(), B = new WeakMap(), q = new WeakMap(), G = new WeakMap(), z = new WeakMap(), Y = new WeakMap();
const Ln = new zi(
  "ContentAuditContext"
...
const Os = (t) => new ws(typeof t == "string" ? t : t + "", void 0, Nn), Ss = (t, e) => {
...
const { is: $s, defineProperty: Ps, getOwnPropertyDescriptor: Us, getOwnPropertyNames: Ls, getOwnPropertySymbols: Ns, getPrototypeOf: ks } = Object, w = globalThis, Qt = w.trustedTypes, Rs = Qt ? Qt.emptyScript : "", Je = w.reactiveElementPolyfillSupport, X = (t, e) => t, lt = { toAttribute(t, e) {
  ...
  return n;
} }, kn = (t, e) => !$s(t, e), Zt = { attribute: !0, type: String, converter: lt, reflect: !1, useDefault: !1, hasChanged: kn };
...
class F extends HTMLElement {
  ...
  _$AK(e, n) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const l = s.getPropertyOptions(i), h = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((a = l.converter) == null ? void 0 : a.fromAttribute) !== void 0 ? l.converter : lt;
      this._$Em = i, this[i] = h.fromAttribute(n, l.type) ?? ((o = this._$Ej) == null ? void 0 : o.get(i)) ?? null, this._$Em = null;
    }
  }
  requestUpdate(e, n, s) {
    var i;
    if (e !== void 0) {
      ...
      if (s ?? (s = a.getPropertyOptions(e)), !((s.hasChanged ?? kn)(o, n) || s.useDefault && s.reflect && o === ((i = this._$Ej) == null ? void 0 : i.get(e)) && !this.hasAttribute(a._$Eu(e, s)))) return;
      this.C(e, n, s);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (i.size > 0) for (const [a, o] of i) {
        const { wrapped: l } = o, h = this[a];
        l !== !0 || this._$AL.has(a) || h === void 0 || this.C(a, void 0, o, h);
      }
    }
    let e = !1;
    const n = this._$AL;
...
F.elementStyles = [], F.shadowRootOptions = { mode: "open" }, F[X("elementProperties")] = /* @__PURE__ */ new Map(), F[X("finalized")] = /* @__PURE__ */ new Map(), Je == null || Je({ ReactiveElement: F }), (w.reactiveElementVersions ?? (w.reactiveElementVersions = [])).push("2.1.0");
...
Se = Vs([
  Es("content-audit-workspace-root")
], Se);
...
class js {
  ...
  async getCollection(e) {
    const { data: n, error: s } = await j(u(this, _e), K.getAllIssues(e));
    if (s)
      return { error: s };
    if (!n)
...
let v = class extends y {
  constructor() {
    ...
    ], this._tableItems = [], nn(this, Z), this.consumeContext(I, (t) => {
...
const Fs = v, Ks = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
}, Js = [Xs], sn = "Umb.Workspace.ContentAudit.AllPagesRoot", M = "Umb.Workspace.ContentAudit.AllPages", Qs = [
  {
    ...
    api: () => import("./all-pages-workspace.context-CVEiI4zk.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-bRdBbzFQ.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-CwHCyUtY.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-DFhTpjri.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-w0r0NLmy.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-BkrLKxRw.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
let O = class extends y {
  constructor() {
    ...
    ], this._tableItems = [], on(this, ee), this.consumeContext(I, (t) => {
...
const ia = O, sa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
], oa = [...Qs, ...aa], la = [
  {
    ...
    api: () => import("./all-pages-collection.repository-Cfn-vtrO.js")
  }
], ra = [
  {
    type: "collectionView",
...
], ua = "Umb.Repository.ContentAudit.AllPages.Detail", da = "Umb.Store.ContentAudit.AllPages.Detail", ma = [
  {
    ...
    api: () => import("./all-pages-detail.repository-ClP55Ryb.js")
  },
  {
    type: "store",
    alias: da,
...
}, Ca = [_a], ln = "Umb.Workspace.ContentAudit.IssuesRoot", rn = "Umb.Workspace.ContentAudit.Issues", ba = [
  {
    ...
    api: () => import("./issues-workspace.context-CS6k6qvz.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-B3qcwH49.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
  ...
  ...ya,
  ...Aa
], Ia = "Umb.Repository.ContentAudit.Issues.Detail", ga = "Umb.Store.ContentAudit.Issues.Detail", Ea = [
  {
    type: "repository",
    alias: Ia,
    name: "Issues Detail Repository",
    api: () => import("./issues-detail.repository-DJ4t_4gc.js")
  },
  {
    type: "store",
    alias: ga,
...
const Na = S, ka = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Da = [
  {
    ...
    api: () => import("./status-codes-collection.repository-DV2jBnsi.js")
  }
], Va = [
  {
    type: "collectionView",
...
}, Et = (t, e, n) => e.has(t) || ti("Cannot " + n), ut = (t, e, n) => (Et(t, e, "read from private field"), e.get(t)), Ze = (t, e, n) => e.has(t) ? ti("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), ni = (t, e, n, s) => (Et(t, e, "write to private field"), e.set(t, n), n), wt = (t, e, n) => (Et(t, e, "access private method"), n), ie, Me, se, ii, si, ai;
let $ = class extends y {
  constructor() {
...
const za = $, Ya = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Fa = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-BM_JbY3D.js")
  }
], Ka = [
  {
    type: "collectionView",
...
}, Za = [Qa], Ot = "Umb.Collection.ContentAudit.ImagesAltText", eo = "Umb.CollectionView.ContentAudit.ImagesAltText.Table", li = "Umb.Repository.ContentAuditImagesAltTextCollection";
...
const io = P, so = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], oo = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-Dzf4tQDf.js")
  }
], lo = [
  {
    type: "collectionView",
...
let U = class extends y {
  constructor() {
    ...
    ], this._tableItems = [], pn(this, le), this.consumeContext(I, (t) => {
...
const bo = U, fo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], yo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-Dnyc1mJw.js")
  }
], Ao = [
  {
    type: "collectionView",
...
}, Eo = [go], Lt = "Umb.Collection.ContentAudit.InboundLinks", wo = "Umb.CollectionView.ContentAudit.InboundLinks.Table", yi = "Umb.Repository.ContentAuditInboundLinksCollection";
var Oo = Object.defineProperty, So = Object.getOwnPropertyDescriptor, Ai = (t) => {
  throw TypeError(t);
}, qe = (t, e, n, s) => {
  for (var i = s > 1 ? void 0 : s ? So(e, n) : e, a = t.length - 1, o; a >= 0; a--)
    (o = t[a]) && (i = (s ? o(e, n, i) : o(i)) || i);
  return s && i && Oo(e, n, i), i;
...
let L = class extends y {
  constructor() {
    ...
    ], this._tableItems = [], Cn(this, re), this.consumeContext(I, (t) => {
...
const Po = L, Uo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], No = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-DKC0CZE3.js")
  }
], ko = [
  {
    type: "collectionView",
...
], wi = "Umb.Repository.ContentAuditMetadataCollection", jo = [
  {
    ...
    api: () => import("./metadata-collection.repository-CMiO5u5i.js")
  }
], Bo = [
  {
    type: "collectionView",
  ...
  ...Wo,
  ...qo
], zo = [], Rt = "Umb.Collection.ContentAudit.DuplicateContent", Yo = "Umb.CollectionView.ContentAudit.DuplicateContent.Table", Oi = "Umb.Repository.ContentAuditDuplicateContentCollection";
...
const Ko = N, Xo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Zo = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-DxngBK3B.js")
  }
], el = [
  {
    type: "collectionView",
...
let k = class extends y {
  constructor() {
    ...
    ], this._tableItems = [], tt(this, ce), tt(this, Ye), this.consumeContext(I, (t) => {
      Ui(this, ce, t);
...
const rl = k, cl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], dl = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-hXahc6ZR.js")
  }
], ml = [
  {
    type: "collectionView",
...
const yl = R, Al = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Il = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-TCI7cGRl.js")
  }
], gl = [
  {
    type: "collectionView",
...
}, Nl = [
  {
    ...
    element: () => import("./overview.element-BLGj4ki6.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-CIzsq4jl.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], Rl = [
  {
    ...
    element: () => import("./run-warning-modal.element-DmN_vv2K.js")
  }
], Dl = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-DSzWPOeC.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-CLRTDzXS.js.map
