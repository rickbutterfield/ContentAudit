...
const Xi = v, Ji = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Zi = [Qi], an = "Umb.Workspace.ContentAudit.AllPagesRoot", M = "Umb.Workspace.ContentAudit.AllPages", ea = [
  {
    ...
    api: () => import("./all-pages-workspace.context-CA6pF-AW.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-ssK5NVgg.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-DDaFhr3C.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-JWVaAFYJ.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-DLUybxBO.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-CjacG_oV.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const aa = g, oa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ra = [...ea, ...la], ca = [
  {
    ...
    api: () => import("./all-pages-collection.repository-CzafBNAU.js")
  }
], ua = [
  {
    type: "collectionView",
...
], ma = "Umb.Repository.ContentAudit.AllPages.Detail", pa = "Umb.Store.ContentAudit.AllPages.Detail", ha = [
  {
    ...
    api: () => import("./all-pages-detail.repository-Hj44sjQ0.js")
  },
  {
    type: "store",
    alias: pa,
...
}, fa = [ba], rn = "Umb.Workspace.ContentAudit.IssuesRoot", cn = "Umb.Workspace.ContentAudit.Issues", Ta = [
  {
    ...
    api: () => import("./issues-workspace.context-D4hgA0fX.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-Byp-tiCu.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], wa = "Umb.Repository.ContentAudit.Issues.Detail", Oa = "Umb.Store.ContentAudit.Issues.Detail", ga = [
  {
    ...
    api: () => import("./issues-detail.repository-BuqKoZnr.js")
  },
  {
    type: "store",
    alias: Oa,
...
const Ra = S, Da = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Wa = [
  {
    ...
    api: () => import("./status-codes-collection.repository-Dja1oPSj.js")
  }
], Ma = [
  {
    type: "collectionView",
...
const Ha = $, Fa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Xa = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-C4Le2_02.js")
  }
], Ja = [
  {
    type: "collectionView",
...
const ao = P, oo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ro = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-Cn7X_dJ9.js")
  }
], co = [
  {
    type: "collectionView",
...
const To = U, yo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], vo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-lgOXHFAj.js")
  }
], Io = [
  {
    type: "collectionView",
...
const Lo = L, No = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ro = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-B4HyWMQg.js")
  }
], Do = [
  {
    type: "collectionView",
...
], gs = "Umb.Repository.ContentAuditMetadataCollection", qo = [
  {
    ...
    api: () => import("./metadata-collection.repository-D6MF65-q.js")
  }
], Go = [
  {
    type: "collectionView",
...
const Jo = N, Qo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], tl = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-CjmvzLrA.js")
  }
], nl = [
  {
    type: "collectionView",
...
const ul = k, dl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], pl = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-DcAKZU97.js")
  }
], hl = [
  {
    type: "collectionView",
...
const vl = R, Il = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], wl = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-CEmIJTDS.js")
  }
], Ol = [
  {
    type: "collectionView",
...
}, Pl = [$l], Ul = "Umb.Workspace.ContentAudit.Export", Ll = [
  {
    ...
    element: () => import("./export.element-DuTgxT6s.js"),
    meta: {
      entityType: qs,
      headline: "Export"
    }
...
}, xl = [
  {
    ...
    element: () => import("./overview.element-bheH_NXW.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-DE-FVCLf.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], Bl = [
  {
    ...
    element: () => import("./run-warning-modal.element-B7WOH_F3.js")
  }
], ql = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-CTAtKKNr.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-Bn_0n6ex.js.map
