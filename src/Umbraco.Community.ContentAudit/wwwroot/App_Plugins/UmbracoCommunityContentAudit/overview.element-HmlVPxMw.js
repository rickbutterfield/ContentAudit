...
import { LitElement as U, repeat as N, html as u, nothing as x, css as I, state as w, customElement as L } from "@umbraco-cms/backoffice/external/lit";
import { C as M } from "./index-CnvXRotu.js";
import { UmbModalToken as W, UMB_MODAL_MANAGER_CONTEXT as B } from "@umbraco-cms/backoffice/modal";
import "./run-warning-modal.element-CPQG_UWc.js";
...
}, S = (e, t, a) => t.has(e) || A("Cannot " + a), h = (e, t, a) => (S(e, t, "read from private field"), t.get(e)), v = (e, t, a) => t.has(e) ? A("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), g = (e, t, a, i) => (S(e, t, "write to private field"), t.set(e, a), a), c = (e, t, a) => (S(e, t, "access private method"), a), d, f, _, n, m, O, $, k, y;
let o = class extends T(U) {
  constructor() {
    super(), v(this, n), this.crawlData = [], v(this, d), v(this, f), v(this, _), this.scanRunning = !1, this._topIssues = [], this.consumeContext(z, (e) => {
      ...
      g(this, d, e), this.observe(e == null ? void 0 : e.latestAuditOverview, (t) => {
...
O = function() {
  var e, t, a, i, s, l;
  if (this.scanRunning) {
    const p = this.crawlData.length, D = this.crawlData.filter((r) => r.crawled && !r.external && !r.asset).length, E = this.crawlData.filter((r) => r.crawled && r.external && !r.asset).length, C = this.crawlData.filter((r) => r.crawled && r.asset).length, R = this.crawlData.filter((r) => r.blocked).length;
    return u`
...
//# sourceMappingURL=overview.element-HmlVPxMw.js.map
