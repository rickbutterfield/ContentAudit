...
import { A as p } from "./index-CnvXRotu.js";
...
class y {
  ...
  async getCollection(o) {
    const { data: t, error: r } = await f(a(this, i), p.getLatestAuditData({ query: o }));
    if (r)
      return { error: r };
    if (!t)
...
//# sourceMappingURL=core-web-vitals-collection.repository-1Gcij36M.js.map
