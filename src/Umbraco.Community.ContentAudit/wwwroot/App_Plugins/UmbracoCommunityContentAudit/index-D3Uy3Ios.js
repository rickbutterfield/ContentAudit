...
const Fs = v, Ks = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Js = [Xs], sn = "Umb.Workspace.ContentAudit.AllPagesRoot", M = "Umb.Workspace.ContentAudit.AllPages", Qs = [
  {
    ...
    api: () => import("./all-pages-workspace.context-B7Oczx-K.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-BBsSTeYy.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-DiQaMoBb.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-CnaeK_cs.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-CQ-yk7v5.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-D9MxGDLN.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const ia = O, sa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], oa = [...Qs, ...aa], la = [
  {
    ...
    api: () => import("./all-pages-collection.repository-BepMQDQj.js")
  }
], ra = [
  {
    type: "collectionView",
...
], ua = "Umb.Repository.ContentAudit.AllPages.Detail", da = "Umb.Store.ContentAudit.AllPages.Detail", ma = [
  {
    ...
    api: () => import("./all-pages-detail.repository-BodDFEGS.js")
  },
  {
    type: "store",
    alias: da,
...
}, Ca = [_a], ln = "Umb.Workspace.ContentAudit.IssuesRoot", rn = "Umb.Workspace.ContentAudit.Issues", ba = [
  {
    ...
    api: () => import("./issues-workspace.context-D7c_CXTP.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-DEYc6EeU.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], Ia = "Umb.Repository.ContentAudit.Issues.Detail", ga = "Umb.Store.ContentAudit.Issues.Detail", Ea = [
  {
    ...
    api: () => import("./issues-detail.repository-DKjU7-Ej.js")
  },
  {
    type: "store",
    alias: ga,
...
const Na = S, ka = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Da = [
  {
    ...
    api: () => import("./status-codes-collection.repository-DqjCPKh7.js")
  }
], Va = [
  {
    type: "collectionView",
...
const za = $, Ya = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Fa = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-BnnInadI.js")
  }
], Ka = [
  {
    type: "collectionView",
...
const io = P, so = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], oo = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-BwFbGKgQ.js")
  }
], lo = [
  {
    type: "collectionView",
...
const bo = U, fo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], yo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-CelweaMP.js")
  }
], Ao = [
  {
    type: "collectionView",
...
const Po = L, Uo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], No = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-CI1j26By.js")
  }
], ko = [
  {
    type: "collectionView",
...
], wi = "Umb.Repository.ContentAuditMetadataCollection", jo = [
  {
    ...
    api: () => import("./metadata-collection.repository-DvmEOZLB.js")
  }
], Bo = [
  {
    type: "collectionView",
...
const Ko = N, Xo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Zo = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-COi9nLXQ.js")
  }
], el = [
  {
    type: "collectionView",
...
const rl = k, cl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], dl = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-CoDuWowI.js")
  }
], ml = [
  {
    type: "collectionView",
...
const yl = R, Al = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Il = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-bIIpdayG.js")
  }
], gl = [
  {
    type: "collectionView",
...
}, Nl = [
  {
    ...
    element: () => import("./overview.element-DZXAB17b.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-DLUOFgYf.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], Rl = [
  {
    ...
    element: () => import("./run-warning-modal.element-BDy4ZiQN.js")
  }
], Dl = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-IjuDWXmZ.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-D3Uy3Ios.js.map
