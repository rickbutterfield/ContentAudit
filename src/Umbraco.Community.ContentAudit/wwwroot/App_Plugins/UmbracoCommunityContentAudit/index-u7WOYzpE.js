...
const Xi = v, Ji = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Zi = [Qi], an = "Umb.Workspace.ContentAudit.AllPagesRoot", M = "Umb.Workspace.ContentAudit.AllPages", ea = [
  {
    ...
    api: () => import("./all-pages-workspace.context-jIiMw91l.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-DR6ucOw6.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-B5eSbBW2.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-Qh9loScF.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-YmjYHFbq.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-D7j-8XO9.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const aa = g, oa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ra = [...ea, ...la], ca = [
  {
    ...
    api: () => import("./all-pages-collection.repository-De-5QK0f.js")
  }
], ua = [
  {
    type: "collectionView",
...
], ma = "Umb.Repository.ContentAudit.AllPages.Detail", pa = "Umb.Store.ContentAudit.AllPages.Detail", ha = [
  {
    ...
    api: () => import("./all-pages-detail.repository-Bzx09EOx.js")
  },
  {
    type: "store",
    alias: pa,
...
}, fa = [ba], rn = "Umb.Workspace.ContentAudit.IssuesRoot", cn = "Umb.Workspace.ContentAudit.Issues", Ta = [
  {
    ...
    api: () => import("./issues-workspace.context-CTLNHQGm.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-BNrmVoFK.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], wa = "Umb.Repository.ContentAudit.Issues.Detail", Oa = "Umb.Store.ContentAudit.Issues.Detail", ga = [
  {
    ...
    api: () => import("./issues-detail.repository-0zvXHwfr.js")
  },
  {
    type: "store",
    alias: Oa,
...
const Ra = S, Da = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Wa = [
  {
    ...
    api: () => import("./status-codes-collection.repository-CA9PYO3U.js")
  }
], Ma = [
  {
    type: "collectionView",
...
const Ha = $, Fa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Xa = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-CcBPcQDU.js")
  }
], Ja = [
  {
    type: "collectionView",
...
const ao = P, oo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ro = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-EGVAzVK2.js")
  }
], co = [
  {
    type: "collectionView",
...
const To = U, yo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], vo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-e1swp2Vu.js")
  }
], Io = [
  {
    type: "collectionView",
...
const Lo = L, No = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ro = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-evt58cst.js")
  }
], Do = [
  {
    type: "collectionView",
...
], gs = "Umb.Repository.ContentAuditMetadataCollection", qo = [
  {
    ...
    api: () => import("./metadata-collection.repository-BDRhJ70C.js")
  }
], Go = [
  {
    type: "collectionView",
...
const Jo = N, Qo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], tl = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-Y3M-hlx7.js")
  }
], nl = [
  {
    type: "collectionView",
...
const ul = k, dl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], pl = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-Bdn1QSOY.js")
  }
], hl = [
  {
    type: "collectionView",
...
const vl = R, Il = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], wl = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-MDpy_WV7.js")
  }
], Ol = [
  {
    type: "collectionView",
...
}, Pl = [$l], Ul = "Umb.Workspace.ContentAudit.Export", Ll = [
  {
    ...
    element: () => import("./export.element-CUjtNJFR.js"),
    meta: {
      entityType: qs,
      headline: "Export"
    }
...
}, xl = [
  {
    ...
    element: () => import("./overview.element-CM60l5XQ.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-C7fLDJTC.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], Bl = [
  {
    ...
    element: () => import("./run-warning-modal.element-C9ztlEV6.js")
  }
], ql = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-D6gLCLc9.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-u7WOYzpE.js.map
