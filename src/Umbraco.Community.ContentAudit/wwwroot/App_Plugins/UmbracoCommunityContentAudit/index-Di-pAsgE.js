...
const gs = I, vs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Symbol.toStringTag, { value: "Module" })), Tt = "ContentAudit.Collection.Audits", ws = "ContentAudit.CollectionView.Audits.Table", Ga = "ContentAudit.Repository.AuditsCollection", Is = [
  {
    ...
    api: () => import("./audits-collection.repository-BRrXAHpp.js")
  }
], Os = [
  {
    type: "collectionView",
...
], Xa = "audits", Ja = "audits-root", Ss = [
  {
    ...
    weight: 100,
    api: () => import("./delete-audit.action-DyiXIJnX.js"),
    forEntityTypes: [Xa],
    meta: {
      icon: "icon-trash",
      label: "Delete"
...
], Ps = [
  {
    ...
    api: () => import("./audits-tree.repository-CEhCUAFe.js")
  },
  {
    type: "tree",
    kind: "default",
...
], Ls = [
  {
    ...
    api: () => import("./audits-workspace.context-DlhxrJr-.js"),
    meta: {
      entityType: "audits"
    }
  },
  {
    ...
    js: () => import("./audits-overview-workspace-view.element-C6G6DBJs.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  },
  {
    ...
    js: () => import("./audits-issues-workspace-view.element-D2qzZRF6.js"),
    weight: 80,
    meta: {
      label: "Issues",
      pathname: "issues",
...
}, Us = [Rs], ra = "ContentAudit.Workspace.AllPagesRoot", F = "ContentAudit.Workspace.AllPages", Vs = [
  {
    ...
    api: () => import("./all-pages-workspace.context-BcbKCqSv.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-IPPAE7gn.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-CRvKeyhW.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-Dyby66_x.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-CDr0DrQ3.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-D5mtU4Iw.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const js = P, zs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ys = [...Vs, ...qs], Fs = [
  {
    ...
    api: () => import("./all-pages-collection.repository-Dk6DnMj6.js")
  }
], Hs = [
  {
    type: "collectionView",
...
], Gs = "ContentAudit.Repository.AllPages.Detail", Xs = "ContentAudit.Store.AllPages.Detail", Js = [
  {
    ...
    api: () => import("./all-pages-detail.repository-dN4ohob7.js")
  },
  {
    type: "store",
    alias: Xs,
...
}, to = [eo], ua = "ContentAudit.Workspace.IssuesRoot", da = "ContentAudit.Workspace.Issues", ao = [
  {
    ...
    api: () => import("./issues-workspace.context-D9PfmMCH.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-DecbAptQ.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], lo = "ContentAudit.Repository.Issues.Detail", co = "ContentAudit.Store.Issues.Detail", uo = [
  {
    ...
    api: () => import("./issues-detail.repository-Co8OzX1e.js")
  },
  {
    type: "store",
    alias: co,
...
const yo = L, bo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], go = [
  {
    ...
    api: () => import("./status-codes-collection.repository-CgyCkiQn.js")
  }
], vo = [
  {
    type: "collectionView",
...
const Lo = k, ko = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Do = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-DPHGJ0bx.js")
  }
], Ro = [
  {
    type: "collectionView",
...
const zo = N, qo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Fo = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-DrCCN1Fh.js")
  }
], Ho = [
  {
    type: "collectionView",
...
const ar = D, nr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], sr = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-8GXCSzID.js")
  }
], or = [
  {
    type: "collectionView",
...
const _r = R, Cr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Ar = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-BiYH3bBR.js")
  }
], yr = [
  {
    type: "collectionView",
...
], Mn = "ContentAudit.Repository.MetadataCollection", Or = [
  {
    ...
    api: () => import("./metadata-collection.repository-iZj3CaAK.js")
  }
], Er = [
  {
    type: "collectionView",
...
const Dr = U, Rr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Wr = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-DS0-0cv1.js")
  }
], xr = [
  {
    type: "collectionView",
...
const Hr = V, Kr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Xr = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-DJWWxaT5.js")
  }
], Jr = [
  {
    type: "collectionView",
...
const sl = W, ol = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], ll = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-CihKHKFC.js")
  }
], cl = [
  {
    type: "collectionView",
...
}, ml = [pl], hl = "ContentAudit.Workspace.Export", _l = [
  {
    ...
    element: () => import("./export.element-DlajKz3e.js"),
    meta: {
      entityType: ai,
      headline: "Export"
    }
...
}, vl = [
  {
    ...
    element: () => import("./overview.element-DP-ToCi_.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-BGiDpSJo.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], Il = [
  {
    ...
    element: () => import("./run-warning-modal.element-D047oadI.js")
  }
], Ol = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-DIAd60PL.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-Di-pAsgE.js.map
