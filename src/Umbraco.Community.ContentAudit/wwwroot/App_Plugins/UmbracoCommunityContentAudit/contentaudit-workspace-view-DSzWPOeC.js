...
import { ContentAuditAllPagesWorkspaceContext as E, CONTENT_AUDIT_ALL_PAGES_WORKSPACE_CONTEXT as $ } from "./all-pages-workspace.context-CVEiI4zk.js";
...
let s = class extends f(C) {
  ...
  _createRoutes() {
    ...
    t.push({
      path: "details",
      component: () => import("./all-pages-details-workspace-view.element-bRdBbzFQ.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "links",
      component: () => import("./all-pages-links-workspace-view.element-CwHCyUtY.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "images",
      component: () => import("./all-pages-images-workspace-view.element-DFhTpjri.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "resources",
      component: () => import("./all-pages-resources-workspace-view.element-w0r0NLmy.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.push({
      path: "issues",
      component: () => import("./all-pages-issues-workspace-view.element-BkrLKxRw.js"),
      setup: (e) => {
        e._data = this._data;
      }
    }), t.length !== 0 && t.push({
...
//# sourceMappingURL=contentaudit-workspace-view-DSzWPOeC.js.map
