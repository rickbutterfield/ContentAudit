...
var rs = Object.defineProperty, ls = Object.getOwnPropertyDescriptor, Ge = (e, t, n, s) => {
  for (var i = s > 1 ? void 0 : s ? ls(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = (s ? a(t, n, i) : a(i)) || i);
  return s && i && rs(t, n, i), i;
};
let mt = class extends rt(W) {
  constructor() {
...
const d = {
...
}, lt = (e) => typeof e == "string", Rt = (e) => lt(e) && e !== "", Xt = (e) => e instanceof Blob, Ze = (e) => e instanceof FormData, fs = (e) => {
  try {
    return btoa(e);
  } catch {
  ...
  if (e.formData) {
    const t = new FormData(), n = (s, i) => {
      lt(i) || Xt(i) ? t.append(s, i) : t.append(s, JSON.stringify(i));
    };
  ...
  if (Rt(n) && (a.Authorization = `Bearer ${n}`), Rt(s) && Rt(i)) {
    const l = fs(`${s}:${i}`);
    a.Authorization = `Basic ${l}`;
  }
  return t.body !== void 0 && (t.mediaType ? a["Content-Type"] = t.mediaType : Xt(t.body) ? a["Content-Type"] = t.body.type || "application/octet-stream" : lt(t.body) ? a["Content-Type"] = "text/plain" : Ze(t.body) || (a["Content-Type"] = "application/json")), new Headers(a);
}, Is = (e) => {
  var t, n;
  if (e.body !== void 0)
    return (t = e.mediaType) != null && t.includes("application/json") || (n = e.mediaType) != null && n.includes("+json") ? JSON.stringify(e.body) : lt(e.body) || Xt(e.body) || Ze(e.body) ? e.body : JSON.stringify(e.body);
}, gs = async (e, t, n, s, i, o, a) => {
  ...
  try {
    ...
    if (!i.isCancelled) {
      let h = await gs(e, t, o, l, a, T, i);
      for (const Qn of e.interceptors.response._fns)
        h = await Qn(h);
      const fe = await Os(h), Jn = Es(h, t.responseHeader);
      let ye = fe;
...
class qt extends Ke {
  constructor(n) {
    ...
    p(this, M);
    p(this, x);
    this.workspaceAlias = _t, m(this, N, new Nt(void 0)), this.latestAuditOverview = r(this, N).asObservable(), m(this, R, new Ie([], (s) => s.id)), this.pagesWithMissingMetadata = r(this, R).asObservable(), m(this, D, new Ie([], (s) => s.name)), this.topIssues = r(this, D).asObservable(), m(this, M, new Nt(void 0)), this.healthScore = r(this, M).asObservable(), m(this, x, new Nt(void 0)), this.settings = r(this, x).asObservable(), this.provideContext(es, this), this.provideContext(tn, this), m(this, f, new Ps(this));
  }
  getEntityType() {
    return Qe;
  }
...
f = new WeakMap(), N = new WeakMap(), R = new WeakMap(), D = new WeakMap(), M = new WeakMap(), x = new WeakMap();
const tn = new ts(
  "ContentAuditContext"
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pt = globalThis, Jt = pt.ShadowRoot && (pt.ShadyCSS === void 0 || pt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, en = Symbol(), Oe = /* @__PURE__ */ new WeakMap();
let Ns = class {
  constructor(t, n, s) {
  ...
  get styleSheet() {
    ...
    if (Jt && t === void 0) {
      ...
      s && (t = Oe.get(n)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), s && Oe.set(n, t));
    }
    return t;
  }
  toString() {
...
const Rs = (e) => new Ns(typeof e == "string" ? e : e + "", void 0, en), Ds = (e, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ms, defineProperty: xs, getOwnPropertyDescriptor: Ws, getOwnPropertyNames: Vs, getOwnPropertySymbols: js, getPrototypeOf: Bs } = Object, I = globalThis, Se = I.trustedTypes, qs = Se ? Se.emptyScript : "", Dt = I.reactiveElementPolyfillSupport, H = (e, t) => e, Ht = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? qs : null;
      break;
...
B.elementStyles = [], B.shadowRootOptions = { mode: "open" }, B[H("elementProperties")] = /* @__PURE__ */ new Map(), B[H("finalized")] = /* @__PURE__ */ new Map(), Dt == null || Dt({ ReactiveElement: B }), (I.reactiveElementVersions ?? (I.reactiveElementVersions = [])).push("2.0.4");
var Hs = Object.getOwnPropertyDescriptor, zs = (e, t, n, s) => {
  for (var i = s > 1 ? void 0 : s ? Hs(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = a(i) || i);
  return i;
};
let Ct = class extends rt(W) {
  constructor() {
...
}, Zt = (e, t, n) => t.has(e) || an("Cannot " + n), Pe = (e, t, n) => (Zt(e, t, "read from private field"), t.get(e)), Le = (e, t, n) => t.has(e) ? an("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), ei = (e, t, n, s) => (Zt(e, t, "write to private field"), t.set(e, n), n), zt = (e, t, n) => (Zt(e, t, "access private method"), n), Y, z, rn, te;
let y = class extends L {
  constructor() {
    super(), Le(this, z), this.data = [], this._tableConfig = {
      ...
      ei(this, Y, e), zt(this, z, rn).call(this);
    });
  }
  updated(e) {
...
const ni = y, si = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  default: ni
}, Symbol.toStringTag, { value: "Module" })), ln = "issues-root", ii = {
  type: "menuItem",
...
}, oi = [ii], ke = "Umb.Workspace.ContentAudit.IssuesRoot", Ne = "Umb.Workspace.ContentAudit.Issues", ai = [
  {
    ...
    api: () => import("./issues-workspace.context-BZ5BgVPT.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-DFOPEZlM.js"),
    weight: 90,
    meta: {
...
], pi = "Umb.Repository.ContentAudit.Issues.Detail", mi = "Umb.Store.ContentAudit.Issues.Detail", hi = [
  {
    ...
    api: () => import("./issues-detail.repository-aa7NkF4o.js")
  },
  {
    type: "store",
    alias: mi,
...
}, ne = (e, t, n) => t.has(e) || dn("Cannot " + n), Yt = (e, t, n) => (ne(e, t, "read from private field"), t.get(e)), Mt = (e, t, n) => t.has(e) ? dn("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), pn = (e, t, n, s) => (ne(e, t, "write to private field"), t.set(e, n), n), se = (e, t, n) => (ne(e, t, "access private method"), n), K, Et, G, mn, hn, _n;
let g = class extends L {
  constructor() {
    ...
    ], this._tableItems = [], Mt(this, K), Mt(this, Et), this.consumeContext(P, (e) => {
      pn(this, K, e);
...
mn = function() {
  new It(this, At).addAdditionalPath(":entityType").onSetup((e) => ({ data: { entityType: e.entityType, preset: {} } })).observeRouteBuilder((e) => {
    pn(this, Et, e), se(this, G, hn).call(this);
  });
};
hn = function() {
    ...
    return {
      ...
      data: [
        ...
        },
        {
          ...
          value: c`<content-audit-status-code-label .statusCode=${n.statusCode}></content-audit-status-code-label>`
        }
      ]
    };
  });
...
const vi = g, Ii = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  get ContentAuditStatusCodesTableCollectionViewElement() {
    return g;
  },
  default: vi
}, Symbol.toStringTag, { value: "Module" })), Re = "Umb.Workspace.ContentAudit.StatusCodes", gi = [
  {
    type: "workspace",
    kind: "default",
    alias: Re,
...
], Ei = [
  {
    ...
    api: () => import("./status-codes-collection.repository-GPhLztIu.js")
  }
], Oi = [
  {
    type: "collectionView",
...
const Ni = E, Ri = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  get ContentAuditOrphanedPagesTableCollectionViewElement() {
    return E;
  },
  default: Ni
}, Symbol.toStringTag, { value: "Module" })), De = "Umb.Workspace.ContentAudit.OrphanedPages", Di = [
  {
    type: "workspace",
    kind: "default",
    alias: De,
...
], Mi = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-CsnPZXTQ.js")
  }
], xi = [
  {
    type: "collectionView",
...
}, Bi = [ji], re = "Umb.Collection.ContentAudit.ImagesAltText", qi = "Umb.CollectionView.ContentAudit.ImagesAltText.Table", gn = "Umb.Repository.ContentAuditImagesAltTextCollection";
var Hi = Object.defineProperty, zi = Object.getOwnPropertyDescriptor, En = (e) => {
  throw TypeError(e);
}, St = (e, t, n, s) => {
  for (var i = s > 1 ? void 0 : s ? zi(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = (s ? a(t, n, i) : a(i)) || i);
  return s && i && Hi(t, n, i), i;
}, le = (e, t, n) => t.has(e) || En("Cannot " + n), Gt = (e, t, n) => (le(e, t, "read from private field"), t.get(e)), Wt = (e, t, n) => t.has(e) ? En("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), On = (e, t, n, s) => (le(e, t, "write to private field"), t.set(e, n), n), ce = (e, t, n) => (le(e, t, "access private method"), n), J, $t, Q, wn, Sn, $n;
...
wn = function() {
  new It(this, At).addAdditionalPath(":entityType").onSetup((e) => ({ data: { entityType: e.entityType, preset: {} } })).observeRouteBuilder((e) => {
    On(this, $t, e), ce(this, Q, Sn).call(this);
  });
};
Sn = function() {
...
const Yi = O, Ki = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
], Fi = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-C77vLnAs.js")
  }
], Xi = [
  {
    type: "collectionView",
...
}, de = (e, t, n) => t.has(e) || Ln("Cannot " + n), xe = (e, t, n) => (de(e, t, "read from private field"), t.get(e)), We = (e, t, n) => t.has(e) ? Ln("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), io = (e, t, n, s) => (de(e, t, "write to private field"), t.set(e, n), n), kn = (e, t, n) => (de(e, t, "access private method"), n), Z, ft, Nn, Rn;
...
Nn = function() {
  xe(this, Z) && this.observe(xe(this, Z).items, (e) => kn(this, ft, Rn).call(this, e), "umbCollectionItemsObserver");
};
Rn = function(e) {
  this._tableItems = e.map((t) => {
    var n;
...
const oo = w, ao = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  default: oo
}, Symbol.toStringTag, { value: "Module" })), Ve = "Umb.Workspace.ContentAudit.OutboundLinks", ro = [
  {
    type: "workspace",
    kind: "default",
    alias: Ve,
...
], lo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-BSANq9My.js")
  }
], co = [
  {
    type: "collectionView",
...
const yo = S, To = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], vo = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-DFy7Sbm_.js")
  }
], Io = [
  {
    type: "collectionView",
...
}, wo = [Oo], he = "Umb.Collection.ContentAudit.Metadata", So = "Umb.CollectionView.ContentAudit.Metadata.Table", He = "Umb.Workspace.ContentAudit.Metadata", $o = [
  {
    type: "workspace",
    kind: "default",
    alias: He,
...
], qn = "Umb.Repository.ContentAuditMetadataCollection", Uo = [
  {
    ...
    api: () => import("./metadata-collection.repository-23lHTdo5.js")
  }
], Po = [
  {
    type: "collectionView",
    ...
    js: () => import("./metadata-table-collection-view.element-BeeyFwb8.js"),
    meta: {
      label: "Table",
      icon: "icon-list",
      pathName: "table"
...
}, Ro = [No], _e = "Umb.Collection.ContentAudit.DuplicateContent", Do = "Umb.CollectionView.ContentAudit.DuplicateContent.Table", zn = "Umb.Repository.ContentAuditDuplicateContentCollection";
...
const Wo = $, Vo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Bo = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-D4SUjJOg.js")
  }
], qo = [
  {
    type: "collectionView",
...
}, Qo = [
  {
    ...
    element: () => import("./overview.element-BI1L3dmC.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-g5Bnx9kT.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], ta = [
  {
    ...
    element: () => import("./run-warning-modal.element-ChWzi2bA.js")
  }
], ea = [
  {
    type: "localization",
...
//# sourceMappingURL=index-CKBR_9pg.js.map
