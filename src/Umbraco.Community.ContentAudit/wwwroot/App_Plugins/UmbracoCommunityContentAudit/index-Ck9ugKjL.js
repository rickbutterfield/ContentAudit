...
const Fs = A, Ks = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Js = [Xs], sn = "Umb.Workspace.ContentAudit.AllPagesRoot", M = "Umb.Workspace.ContentAudit.AllPages", Qs = [
  {
    ...
    api: () => import("./all-pages-workspace.context-BX4pQmuu.js"),
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-details-workspace-view.element-CE5rt-94.js"),
    weight: 100,
    meta: {
  ...
  },
  {
    ...
    js: () => import("./all-pages-links-workspace-view.element-D3F5Fltl.js"),
    weight: 90,
    meta: {
      label: "Links",
      pathname: "links",
  ...
  },
  {
    ...
    js: () => import("./all-pages-images-workspace-view.element-C9b291FP.js"),
    weight: 80,
    meta: {
      label: "Images",
      pathname: "images",
  ...
  },
  {
    ...
    js: () => import("./all-pages-resources-workspace-view.element-GneXeqMD.js"),
    weight: 70,
    meta: {
      label: "Resources",
      pathname: "resources",
  ...
  },
  {
    ...
    js: () => import("./all-pages-issues-workspace-view.element-hjJjsN2Q.js"),
    weight: 60,
    meta: {
      label: "Issues",
      pathname: "issues",
...
const ia = E, sa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], oa = [...Qs, ...aa], la = [
  {
    ...
    api: () => import("./all-pages-collection.repository-lw-XxfZh.js")
  }
], ra = [
  {
    type: "collectionView",
...
], ua = "Umb.Repository.ContentAudit.AllPages.Detail", da = "Umb.Store.ContentAudit.AllPages.Detail", ma = [
  {
    ...
    api: () => import("./all-pages-detail.repository-DtHJB_YC.js")
  },
  {
    type: "store",
    alias: da,
...
}, Ca = [_a], ln = "Umb.Workspace.ContentAudit.IssuesRoot", rn = "Umb.Workspace.ContentAudit.Issues", ba = [
  {
    ...
    api: () => import("./issues-workspace.context-CdNKBUXC.js"),
    meta: {
      entityType: "issues"
    }
  },
  {
    ...
    js: () => import("./issues-details-workspace-view.element-Be3unrWO.js"),
    weight: 90,
    meta: {
      label: "#general_details",
      pathname: "details",
...
], Ia = "Umb.Repository.ContentAudit.Issues.Detail", ga = "Umb.Store.ContentAudit.Issues.Detail", Oa = [
  {
    ...
    api: () => import("./issues-detail.repository-Bk33cFMd.js")
  },
  {
    type: "store",
    alias: ga,
...
const Na = S, ka = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Da = [
  {
    ...
    api: () => import("./status-codes-collection.repository-qum8YmmZ.js")
  }
], Va = [
  {
    type: "collectionView",
...
const za = $, Ya = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Fa = [
  {
    ...
    api: () => import("./orphaned-pages-collection.repository-UhTESMLy.js")
  }
], Ka = [
  {
    type: "collectionView",
...
const io = P, so = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], oo = [
  {
    ...
    api: () => import("./images-alt-text-collection.repository-DCebLDLK.js")
  }
], lo = [
  {
    type: "collectionView",
...
const bo = U, fo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], yo = [
  {
    ...
    api: () => import("./outbound-links-collection.repository-XE4Dd9GQ.js")
  }
], Ao = [
  {
    type: "collectionView",
...
const Po = L, Uo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], No = [
  {
    ...
    api: () => import("./inbound-links-collection.repository-C4UpD54l.js")
  }
], ko = [
  {
    type: "collectionView",
...
], wi = "Umb.Repository.ContentAuditMetadataCollection", jo = [
  {
    ...
    api: () => import("./metadata-collection.repository-bc8WUq2i.js")
  }
], Bo = [
  {
    type: "collectionView",
...
const Ko = N, Xo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Zo = [
  {
    ...
    api: () => import("./duplicate-content-collection.repository-RZRjaKTZ.js")
  }
], el = [
  {
    type: "collectionView",
...
const rl = k, cl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], dl = [
  {
    ...
    api: () => import("./carbon-rating-collection.repository-BcF3jFlI.js")
  }
], ml = [
  {
    type: "collectionView",
...
const yl = R, Al = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
], Il = [
  {
    ...
    api: () => import("./core-web-vitals-collection.repository-BG2SbxCZ.js")
  }
], gl = [
  {
    type: "collectionView",
...
}, Nl = [
  {
    ...
    element: () => import("./overview.element-CwP1QAu4.js"),
    meta: {
      label: "Overview",
      pathname: "overview",
      icon: "icon-scan"
  ...
  },
  {
    ...
    element: () => import("./settings.element-CaEzpB3A.js"),
    meta: {
      label: "Settings",
      pathname: "settings",
...
], Rl = [
  {
    ...
    element: () => import("./run-warning-modal.element--bbX8l9_.js")
  }
], Dl = [
  {
    type: "localization",
  ...
  js: () => import("./contentaudit-workspace-view-e2fPQuJw.js"),
  weight: 150,
  meta: {
    label: "Audit",
    pathname: "audit",
...
//# sourceMappingURL=index-Ck9ugKjL.js.map
