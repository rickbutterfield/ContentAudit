...
import { t as C } from "./index-CTGZ8jTt.js";
import { r as m } from "./state-BHWkriQ1.js";
import { CONTENT_AUDIT_AUDITS_WORKSPACE_CONTEXT as T } from "./audits-workspace.context-5GbVvzHw.js";
...
var I = Object.defineProperty, P = Object.getOwnPropertyDescriptor, h = (e) => {
  throw TypeError(e);
}, u = (e, t, s, a) => {
  for (var r = a > 1 ? void 0 : a ? P(t, s) : t, c = e.length - 1, d; c >= 0; c--)
    (d = e[c]) && (r = (a ? d(t, s, r) : d(r)) || r);
  return a && r && I(t, s, r), r;
}, f = (e, t, s) => t.has(e) || h("Cannot " + s), y = (e, t, s) => (f(e, t, "read from private field"), t.get(e)), v = (e, t, s) => t.has(e) ? h("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), $ = (e, t, s, a) => (f(e, t, "write to private field"), t.set(e, s), s), p = (e, t, s) => (f(e, t, "access private method"), s), n, l, _, b, g, w;
let i = class extends x {
  constructor() {
    super(), v(this, l), this._issues = [], v(this, n), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
...
//# sourceMappingURL=audits-issues-workspace-view.element-BSYm0Wo8.js.map
