...
{
    [Tree(Constants.SectionAlias, "inbound-links", TreeGroup = Constants.Trees.Audit.Group, SortOrder = 3)]
    ...
    public class InboundLinksTreeController : TreeController
    {
        ...
        protected override ActionResult<TreeNode?> CreateRootNode(FormCollection queryStrings)
        {
            ...
            if (root is not null)
            {
                root.RoutePath = $"{Constants.SectionAlias}/inbound-links/overview";
