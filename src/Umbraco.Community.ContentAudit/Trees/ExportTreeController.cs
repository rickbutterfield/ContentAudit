...
{
    [Tree(Constants.SectionAlias, "export", TreeGroup = Constants.Trees.Tools.Group, TreeTitle = "Tools", SortOrder = -1)]
    [PluginController("UmbracoCommunityContentAudit")]
    public class ExportTreeController : TreeController
    {
        private readonly IMenuItemCollectionFactory _menuItemCollectionFactory;

        public ExportTreeController(ILocalizedTextService localizedTextService,
        ...
        protected override ActionResult<TreeNode?> CreateRootNode(FormCollection queryStrings)
        {
            ...
            if (root is not null)
            {
                root.RoutePath = $"{Constants.SectionAlias}/export/overview";
                root.Name = "Export";
                root.Icon = "icon-download";
