...
export class ContentAuditStatusCodesCollectionRepository extends UmbRepositoryBase implements UmbCollectionRepository<PageListItemDto, ContentAuditStatusCodesCollectionFilterModel> {
