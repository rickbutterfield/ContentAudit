...
export class ContentAuditAllPagesCollectionRepository extends UmbRepositoryBase implements UmbCollectionRepository<PageListItemDto, ContentAuditAllPagesCollectionFilterModel> {
