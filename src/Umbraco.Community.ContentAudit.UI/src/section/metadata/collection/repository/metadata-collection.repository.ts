...
export class ContentAuditMetadataCollectionRepository extends UmbRepositoryBase implements UmbCollectionRepository<MetadataListItemDto, UmbCollectionFilterModel> {
