...
export class ContentAuditOutboundLinksCollectionRepository extends UmbRepositoryBase implements UmbCollectionRepository<ExternalPageGroupDto, UmbCollectionFilterModel> {
